...
namespace DAL
{
    public class DatabaseContext : DbContext
    {
        ...
        public  DbSet<PersonStatusView> PersonStatusViews { get; set; }
        ...
        */
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MojodiMandehVam>(entity =>
            {
                ...
                entity.Property(e => e.Mojodi).HasColumnType("numeric(38, 0)");
            ...
            modelBuilder.Entity<Pardar>(entity =>
            {
                entity
                    .HasNoKey()
                    .ToTable("PARDAR", tb => tb.HasTrigger("PardarTrigger"));
            ...
            modelBuilder.Entity<PersonStatusView>(entity =>
            {
                entity
                    .HasNoKey()
                    .ToView("Person_Status_View");
                ...
                entity.Property(e => e.Date)
                    ...
                    .IsFixedLength()
                    .HasColumnName("date");
                entity.Property(e => e.Fam).HasMaxLength(78);
                entity.Property(e => e.GstPaid).HasColumnType("numeric(38, 0)");
                entity.Property(e => e.HesabNo).HasColumnName("Hesab_no");
                entity.Property(e => e.Karmozd).HasColumnName("karmozd");
                entity.Property(e => e.Pasandaz).HasColumnType("numeric(38, 0)");
                entity.Property(e => e.Pcode)
                    .HasMaxLength(5)
                    .IsUnicode(false)
                    .IsFixedLength()
                ...
                entity.Property(e => e.SexTitle)
                    .HasMaxLength(5)
                    .IsUnicode(false);
                entity.Property(e => e.Vam).HasColumnType("numeric(38, 0)");
            });
